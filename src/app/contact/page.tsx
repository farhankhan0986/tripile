      ...
      <section className="py-[48px] lg:py-[96px]">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-[32px] lg:gap-[48px] items-start">
            ...
            {/* ── Left: Form ── */}
            <div
              className="rounded-[24px] p-[24px] lg:p-[48px]"
              style={{
                background: "#fff",
            ...
            >
              {submitted ? (
                <div className="flex flex-col items-center justify-center text-center py-[48px] gap-[24px]">
                  ...
                  <div>
                    <h2 className="font-display font-semibold text-[26px] lg:text-[34px] text-warm-dark mb-[10px]">
                      Message received
                    </h2>
                ...
                <>
                  ...
                  <div className="flex items-start justify-between mb-[36px]">
                    <div>
                      <h2 className="font-display font-semibold text-[26px] lg:text-[34px] text-warm-dark leading-[1.05] mb-[6px]">
                        Send us a message
                      </h2>
