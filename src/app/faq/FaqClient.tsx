    ...
    faqs: [
      {
        ...
        a: "Yes. Tripile is a fully licensed and accredited travel agency, an ASTA (American Society of Travel Advisors) member, and IATA accredited. We have been in business since 2022 and hold a BBB A+ rating. Our agents are licensed and undergo regular training.",
      },
      {
          ...
          <div className="grid lg:grid-cols-[260px_1fr] gap-[32px] lg:gap-[48px] items-start">
            <div className="lg:sticky lg:top-[96px] flex flex-col gap-[8px]">
              ...
              {categories.map((cat, i) => (
                ...
                >
                  {cat.label}
                  <span className="ml-[8px] font-body text-[11px]" style={{ opacity: 0.55 }}>
                    ({cat.faqs.length})
                  </span>
                </button>
              ))}
              ...
              <div
                ...
                style={{ background: "linear-gradient(135deg, #5C1828 0%, #3D0E1A 100%)" }}
              >
                <div className="flex items-center gap-[8px]">
                  <MessageCircle size={14} color="#C9A84C" />
                  <p className="font-body font-semibold text-[12px] text-white">Still have questions?</p>
                </div>
            ...
            <div>
              ...
              <div
                ...
                style={{ background: "#fff", border: "1px solid #EDE0CC", boxShadow: "0 4px 24px rgba(26,15,13,0.06)" }}
              >
